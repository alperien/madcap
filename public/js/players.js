            ...
            for (var t = 0; t < tierOrder.length; t++) {
                ...
                for (var b = 0; b < tierBadges.length; b++) {
                    ...
                    if (EDIT_MODE) {
                        ...
                        if (origIdx >= 0) html += '<a href="#" onclick="deleteBadge(\'' + player.id + '\',' + origIdx + ');return false;" class="gensmall" style="color:var(--accent-red);font-size:7px;margin:0 2px 0 1px;">x</a>';
                    }
                }
                html += '</div>';
            }
